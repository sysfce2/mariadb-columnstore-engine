...
local Pipeline(branch, platform, event, arch='amd64', server='10.6-enterprise') = {
  ...
  local prepareTestStage(dockerImage, pkg_format, result) = [
    ...
    execInnerDocker('/setup-repo.sh', dockerImage),
  ...
  smoke:: {
    ...
    commands: [
      ...
      + prepareTestStage(dockerImage("smoke"), pkg_format, result) + [
  ...
  upgrade(version):: {
    ...
    commands: [
      ...
      + prepareTestStage(dockerImage('upgrade') + version, pkg_format, result) + [
      if (pkg_format == 'deb' && !(result == "debian12") && !(arch == "arm64" && (version == "10.6.4-1" || version == "10.6.5-2" || version == "10.6.7-3" || version == "10.6.8-4")) && !((version == "10.6.4-1" || version == "10.6.8-4") && (result == "debian11" || result == "ubuntu22.04")) && !(result == "ubuntu22.04" && (version == "10.6.5-2" || version == "10.6.7-3")))
      ...
      if (std.split(platform, ':')[0] == 'rockylinux' && !(result == "rockylinux9" && (version == "10.6.4-1" || version == "10.6.5-2" || version == "10.6.7-3" || version == "10.6.8-4")) && !(result == "rockylinux8" && arch == 'arm64' && (version == "10.6.5-2" || version == "10.6.7-3" || version == "10.6.8-4")))
  ...
  mtr:: {
    ...
    commands: [
      ...
      + prepareTestStage('mtr$${DRONE_BUILD_NUMBER}', pkg_format, result) + [
  ...
  prepare_regression:: {
    ...
    commands: [
      ...
      + prepareTestStage(dockerImage('regression'), pkg_format, result) + [
  ...
  cmapitest:: {
    ...
    commands: [
      ...
      prepareTestStage(dockerImage('cmapi'), pkg_format, result) + [
